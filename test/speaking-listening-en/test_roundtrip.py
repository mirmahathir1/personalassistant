#!/usr/bin/env python3
"""Round-trip English TTS audio through English speech-to-text."""
...
def normalize_text(text: str) -> str:
    ...
    without_punctuation = "".join(
        char for char in normalized if char not in string.punctuation
    )
